...
export let db = {
    rooms: {
        westOfHouse: new Room({id: 0, name: "West of House", description: "This is west of house.", exits: {north: "northOfHouse", east: null, west: null, south: null}, background: 'west-of-house.png', objectList: ["mailbox", "mailboxBack", "mailboxDoor", "letter"]}),
        northOfHouse: new Room({id: 1, name: "North of House", description: "This is north of house.", exits: {north: null, east: null, west: null, south: "westOfHouse"},background: 'north-of-house.png'}),
    },
    entities: {
