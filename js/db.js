...
export let db = {
    rooms: {
        ...
        northOfHouse: new Room({id: 1, name: "North of House", objectList: ['cellarDoor'], description: 'This is the north side of the house, where you notice a cellar door.', exits: {west: "westOfHouse"}, background: 'north-of-house.png'}),
        southOfHouse: new Room({id: 2, name: 'South of House', description: 'As you approach the south side of the house, you notice a window that is slightly ajar. To the west, you can return back the way you came.', exits: {west: 'westOfHouse'}, background: 'south-of-house.png', objectList: ['southWindow']}),
    ...
    entities: {
        ...
        southWindow: new Entity({id: 4, name: 'A window', description: 'The window is sligthly ajar. The other side looks like a kitchen. You could probably open the window further.', urlList: ['south-window0.png', 'south-window1.png'], width: 335, height: 206, x: 500, y: 100, eventList: ['window0', 'window1']}),
        ...
        well: new Entity({id: 7, name: 'a well', eventList: ['well0'], description: "A deep well lies before you. When you look down, all you see is a pitch black abyss.", urlList: ['well0.png', 'well1.png'], width: 637, height: 537, x: 225, y: 228}),
        ...
        lantern: new Entity({id: 9, name: 'a lantern', eventList: ['lantern0'], description: 'This is no ordinary lantern. You can feel the magic pulsing off of it.', urlList: ['lantern.png'], width: 43, height: 94, x: 478, y: 270, points: 100, inventoryThumbnail: ['lantern.png']}),
    },
}
